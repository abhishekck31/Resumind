...
const Upload = () => {
    ...
    const handleAnalyze = async ({ companyName, jobTitle, jobDescription, file }: { companyName: string, jobTitle: string, jobDescription: string, file: File }) => {
        ...
        try {
            ...
            console.log('🖼️ Step 2: Converting to image...');
            setStatusText('Converting to image...');
            const imageFile = await convertPdfToImage(file);
            console.log('✅ Conversion complete:', imageFile);
            ...
            console.log('🤖 Step 5: Calling AI for analysis...');
            ...
            console.log('📝 Raw AI response text:', feedbackText);

            // Remove markdown code blocks if present
            feedbackText = feedbackText.replace(/```json/g, '').replace(/```/g, '').trim();
            console.log('🧹 Cleaned text:', feedbackText);
